...
function Aside() {
    ...
    return (
        <aside className="text-white group fixed inset-x-0 bottom-0 z-40 w-full shrink-0 border-t border-white/10 bg-[#050505]/95 px-2 py-1.5 backdrop-blur sm:absolute sm:inset-y-0 sm:max-w-[72px] sm:border-r sm:border-t-0 sm:bg-[#121212] sm:py-6 sm:hover:max-w-[260px]">
